...
## ToDo
* Ich muss es schaffen, dass der Frontmatter ignoriert wird, den brauchen wir ja nicht, aber aktuell wird er angezeigt.
* embedding code (iframes) von Diensten erlauben

<iframe data-testid="embed-iframe" style="border-radius:12px" src="https://open.spotify.com/embed/track/7JThsKQRZacFinuHF6cpYH?utm_source=generator&si=d6874841be594489" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
